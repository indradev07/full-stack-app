    ...
    return (
        <>
            ...
            <div class="relative flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg">
                <div class="relative h-56 overflow-hidden text-white rounded-md rounded-b-none">
                ...
                <div className="absolute top-4 right-4 text-white text-2xl p-2 bg-transparent border border-white bg-opacity-50 rounded-full w-10 h-10 flex items-center justify-center transition duration-200 hover:bg-opacity-70">
                    <button className={`${favorite ? "text-red-500" : "text-white-500"}`} onClick={onFavoriteClick}>
                        ♥
                    </button>
                </div>
                <div class="p-4 pb-0">
                    <div class="flex items-center mb-2">
                        <h6 class="text-[#3C948B] text-xl font-semibold">
                            {show.name}
                        </h6>
                    </div>
                </div>

                <div class="p-4 pt-0 mb-2 group inline-flex flex-wrap justify-between items-center gap-2">
                    ...
                    <button class="rounded-full border border-slate-300 py-2 px-4 text-center text-sm transition-all shadow-sm hover:shadow-lg text-slate-600 hover:text-white hover:bg-[#3C948B] hover:border-[#3C948B] focus:text-white focus:bg-[#3C948B] focus:border-[#3C948B] active:border-[#3C948B] active:text-white active:bg-[#3C948B] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
                        <div class="flex items-center gap-0 5 ml-auto">
                            ...
                            <span class="text-slate-600 ml-1.5">{show.rating}</span>
                        </div>
                    </button>
                </div>
            </div>
